...
public class v1_13_R1 implements VersionWrapper {
	...
	public Entity loadEntityFromNBT(Object compound, World world) {
		...
		net.minecraft.server.v1_13_R1.Entity nmsEntity = EntityTypes.a((NBTTagCompound)compound, nmsWorld);
	...
	public String getEntityTypeName(EntityType entityType) {
		return new ChatMessage(SystemUtils.a("entity", new MinecraftKey(entityType.getName()))).getString();
	}
}
