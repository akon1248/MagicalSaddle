...
public class v1_12_R1 implements VersionWrapper {
	...
	public Object getTag(ItemStack stack) {
		...
		return Optional.ofNullable(nmsStack.getTag()).orElseGet(() -> {
	...
	public Entity loadEntityFromNBT(Object compound, World world) {
		...
		net.minecraft.server.v1_12_R1.Entity nmsEntity = EntityTypes.a((NBTTagCompound)compound, nmsWorld);
	...
	public String getEntityTypeName(EntityType entityType) {
		String translationKey = EntityTypes.a(new MinecraftKey(entityType.getName()));
		return LocaleI18n.get("entity." + (translationKey == null ? "generic" : translationKey) + ".name");
	}
}
